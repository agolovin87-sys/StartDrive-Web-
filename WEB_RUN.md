...
3. **Роли** — после входа доступны разделы: Админ (главная, баланс, чат, история), Инструктор (главная, запись, чат, билеты, история, настройки), Курсант (аналогично без админ-разделов).
